...
| Authority Enrichment — Ingest + UI deduplication | `marc_ingest.py`, `run.py`, `AuthorityTable.tsx` | ✓ shipped (Rule W-33) | **DONE** 2026-06-17 — role-priority merge, alt_roles audit, group-duplicates toggle |
