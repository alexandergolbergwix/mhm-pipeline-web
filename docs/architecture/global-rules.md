...
- **G2 — Shared converter code is upstream-owned; divergences are explicit.**
  ...
  modular web builder currently has documented W-43/W-68/W-69/W-70/W-71/W-72/W-78 divergences.
...
Full incident history: repo root [CLAUDE.md](../../CLAUDE.md) (W-1…W-78).
