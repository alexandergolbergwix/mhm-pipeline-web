...
- `backend/tests/unit/test_wikidata_nonpassing_buckets.py` — Rule W-170 regression:
  person identifier fail-closed, canonical P921 grounding, description year precision,
  language/facsimile labels, mm dimensions, adoption blocks on conflation.
