...
- `frontend/tests/unit/renderStable.spec.ts`, `useReportDerivedIds.spec.ts`, `runJobsStore.spec.ts`, `useVerifyJob.spec.ts` — R1–R4, R11, R13 (including rejected-enqueue recovery).
