...
| `backend/converter/rdf/graph_builder.py` | Vendored desktop `GraphBuilder` — HMO/CIDOC triple emitter; `_stamp_wikibase_comment` + CU metadata for Wikibase descriptions (Rule W-48); `_add_provenance_events` (line 730) |
