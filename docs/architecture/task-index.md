...
| Debug AI verdicts persisted but showing `—` in the review table | [Wikidata Studio R64–R65](blocks/wikidata-studio/rules.md) + Rules W-136/W-148/W-149 + `wikidata_verdict_cache.py` / verify scope loader |
