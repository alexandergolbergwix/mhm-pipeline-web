...
| Choose Wikidata upload target (dry-run / test / live) | [wikidata-studio](blocks/wikidata-studio/README.md) R6 + Rule W-103; test remaps live P/Q (exact label + datatype, adopt-on-conflict W-187) then refuses leftover snaks (Rules W-182 / W-183 / W-186) |
