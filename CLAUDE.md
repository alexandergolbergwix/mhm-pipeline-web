...
- **W-236** — Cancelling a queued job MUST finalize it: the maintenance pass finalizes queued rows carrying `cancel_requested_at`, and the claim path refuses them
