...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("email_index", sa.LargeBinary(length=32), nullable=False, unique=True),
    ...
    op.create_table(
        ...
        sa.Column("kek_wrapped", sa.LargeBinary(), nullable=False),
        sa.Column("kek_wrap_nonce", sa.LargeBinary(length=12), nullable=False),
