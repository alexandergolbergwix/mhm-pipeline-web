...
class HmoCanonicalEntity(Base):
    ...
    descriptions: Mapped[dict[str, str]] = mapped_column(JSONB, nullable=False, default=dict)
    aliases: Mapped[dict[str, list[str]]] = mapped_column(JSONB, nullable=False, default=dict)
    claims: Mapped[list[dict[str, Any]]] = mapped_column(JSONB, nullable=False, default=list)
    authority_evidence: Mapped[list[dict[str, Any]]] = mapped_column(JSONB, nullable=False, default=list)
