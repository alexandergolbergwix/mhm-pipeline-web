...
| [CLAUDE.md](CLAUDE.md) | Index of the architectural invariants (Rules W-1…W-136) |
| [docs/architecture/rules/](docs/architecture/rules/) | The rules themselves, one file per area |
