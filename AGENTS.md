...
rule (Rules W-1…W-142) and points at the topic file under
...
(W-1…W-142) stay in [docs/architecture/rules/](docs/architecture/rules/), indexed by [CLAUDE.md](CLAUDE.md).
