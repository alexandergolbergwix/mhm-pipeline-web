...
rule (Rules W-1…W-224) and points at the topic file under
...
(W-1…W-224) stay in [docs/architecture/rules/](docs/architecture/rules/), indexed by [CLAUDE.md](CLAUDE.md).
