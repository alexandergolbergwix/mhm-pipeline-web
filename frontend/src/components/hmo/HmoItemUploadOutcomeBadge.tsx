    ...
    <div className="space-y-0.5 max-w-[220px]">
      {clickable ? (
        <button
          ...
          data-testid={localId ? `hmo-item-upload-badge-${localId}` : undefined}
      ...
      {popover && (
        <ClickDetailPopover
          x={popover.x}
          y={popover.y}
          title={outcome === "failed" ? "Upload failed" : "Last push details"}
          testId={localId ? `hmo-item-upload-detail-${localId}` : undefined}
